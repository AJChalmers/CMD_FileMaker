...
//V6: Fixing magnetude problem, trying factors of Lsun to produce practical mags
...
int main() {
	...
	int NumOfModels = 16281; //Total possible number of models. Will be used for largest array possible
	...
	bool MakeCMDsWithPython = false; // When true, will try to run CMD_plotter.py in order to make CMDs. Python program may need to be edited before running.
