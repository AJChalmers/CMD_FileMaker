...
int main() {
	...
	char inputFileName_ForPositiveGrowthModels[50] = "PostiveGrowthClassical"; //input File with model parameters that have positve growth rates. Will have prefix for mode that is defined below. Must be in working directory. Suffix is "_Set.dat"
	...
	bool MakeCMDsWithPython = true; // When true, will try to run CMD_plotter.py in order to make CMDs. Python program may need to be edited before running.
